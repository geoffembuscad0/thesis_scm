...
<?php //echo $pageNotAvail; ?>
<div class="pure-g">
	<div class="pure-u-1-3" style="width: 100%">
	<h1>Willing to be part of the family of Teresa Marble Corporation? Apply Now!</h1>
	</div>
</div>
<div class="pure-g">
	<div class="pure-u-1-3" style="width: 100%;">
	...
	<tbody>
		...
		<td class="input">
		<?php echo Form::input('mobile_contact',null,array("class"=>"applicant_input","placeholder"=>"11 Digit only","maxlength"=>"11")); ?>
		</td>
		</tr>
		<tr>
		...
		<?php echo Form::radio('time_reach', 'evening');?>Evening 
		<?php echo Form::radio('time_reach', 'night'); ?>Night
		</td>
		</tr>
		<tr>
