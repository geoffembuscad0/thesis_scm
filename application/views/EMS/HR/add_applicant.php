...
<div class="pure-g">
	...
	<tbody>
		...
		<tr>
		<td class="label" colspan='2'>Barcode Value<font color='red'>*</font>(user barcode scanner):</td>
		<td class="input" colspan='4'><?php echo Form::input('barcode_value',null,array("class"=>"applicant_input", "placeholder"=>"Barcode Value"));?></td>
		</tr>
		<tr>
