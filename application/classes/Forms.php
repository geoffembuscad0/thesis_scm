...
class Forms {
	public function product_survey_confirmation(){
		return "<div id='productSurveyForm' class='reveal-modal' style='font-size: 16px;color:#000;'>
				...
				<a class='pure-button pure-button-primary' href='".URL::site()."products/product_survey?survey_code=".hash('snefru', 'survey')."'>Yes</a>
	...
	public function inquiry_form($products = array()){
		...
		$html .= "<td>Middlename:<font color='red'>*</font></td><td style='background:#ffffff;'>".Form::input('clientMiddlename', null, array('class'=>'textfield','placeholder'=>'Middlename here','maxlength'=>'50'))."</td>";
		...
		$html .= "<div class='productsInquiry'><select name='products_inquiry[]' style='border: 1px #ffffff;'>";
		...
		$html .= "</select> <input class='buttonAddProduct' type='button' name='Add' value='Add Another'/>";
		$html .= "</div></td></tr>";
